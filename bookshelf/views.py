...
def _return_to_main_anchor(book_id, anchor) :
...
def get_read_book_context(progress, book_id):
...
@on_progress
def view_read_book(request, progress, book_id) :
...
@on_progress
def view_save_to(request, progress, book_id: int, save_id=None):
    """create/upd save"""
