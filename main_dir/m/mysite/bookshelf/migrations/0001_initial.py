# Generated by Django 3.2.11 on 2022-03-17 17:29
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cover_img', models.ImageField(blank=True, upload_to=bookshelf.utilities.get_timestamp_path, verbose_name='Обложка книги')),
            ],
        ),
        migrations.CreateModel(
            name='BookPage',
        ...
        migrations.AddField(
            model_name='book',
            name='first_page',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='first_page', to='bookshelf.bookpage', verbose_name='Стартовая страница'),
        ),
        migrations.CreateModel(
            name='PageLink',
            fields=[
